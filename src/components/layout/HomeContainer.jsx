  ...
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
      <div className='py-2 flex flex-col items-start  justify-center flex-1 gap-6'>
        ...
        <button
          type='button'
          className='bg-gradient-to-br from-orange-400 to-orange-600 w-full md:w-auto px-4 py-2 rounded-lg hover:shadow-lg transition-all ease-in-out duration-100 text-primary'>
          Order Now
        </button>
      </div>
